...
python test.py ^
    ...
    --pretrained .\models\scratch\superblue11_a\model_iters_200.pth ^
...
python test.py ^
    --task congestion_transfer_learning ^
    --pretrained .\models\scratch\superblue14\model_iters_200.pth ^
    --dataroot .\data\target_dataset\transfer_learning_datasets\superblue12\ ^
    --ann_file_test .\data\target_dataset\transfer_learning_datasets\superblue12.csv ^
    --dataset_type SuperBlueDataset ^
...
python test.py ^
    --task congestion_transfer_learning ^
    --pretrained .\models\scratch\superblue16_a\model_iters_200.pth ^
    --dataroot .\data\target_dataset\transfer_learning_datasets\superblue12\ ^
    --ann_file_test .\data\target_dataset\transfer_learning_datasets\superblue12.csv ^
    --dataset_type SuperBlueDataset ^
...
python test.py ^
    --task congestion_transfer_learning ^
    --pretrained .\models\scratch\superblue19\model_iters_200.pth ^
    --dataroot .\data\target_dataset\transfer_learning_datasets\superblue12\ ^
    --ann_file_test .\data\target_dataset\transfer_learning_datasets\superblue12.csv ^
    --dataset_type SuperBlueDataset ^
